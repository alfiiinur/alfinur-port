...
export default function LocationSection() {
  ...
  const googleMapsEmbedUrl = "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d247.2297575873763!2d112.6895401720673!3d-7.500962627369682!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7e097924dd0e3%3A0xcdcfd77f945f48b7!2sWates%2C%20Kedensari%2C%20Tanggulangin%2C%20Sidoarjo%20Regency%2C%20East%20Java%2061272!5e0!3m2!1sen!2sid!4v1764543991237!5m2!1sen!2sid";
      ...
      >
        ...
        <div className="absolute top-6 left-6 md:top-10 md:left-10 bg-white p-6 rounded-2xl shadow-xl max-w-xs z-10 transition-transform duration-300 hover:-translate-y-1">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-gray-900 text-lg">Anantara Oceanfront Resort</h3>
              <p className="text-gray-500 text-sm mt-1">
                123 Serenity Bay Road<br />
                AL Danah, Abu Dhabi 84320
              </p>
              
              <div className="mt-4 pt-4 border-t border-gray-100">
                <p className="text-xs text-gray-400">
                  Located 25 minutes from AL Nahyan International Airport.
                </p>
              </div>
            </div>
          </div>
